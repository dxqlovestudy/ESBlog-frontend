        ...
        <el-col :span="24" class="s-item tcommonBox" v-for="(item,index) in articleList" :key="'article'+index">
            ...
            <header>
                ...
                <h2>
                    ...
                    <i class="fa fa-fw fa-clock-o"></i><span v-html="showInitDate(item.createTime,'newDate')"></span> •
                    <!-- <i class="fa fa-fw fa-user"></i>发表于 <span >{{articleList.createTime}}</span> • -->
                    ...
                    <!-- <i class="fa fa-fw fa-clock-o"></i><span>{{ item.createTime }} - {{ showInitDate(item.createTime,'all') }}</span> -->
                    <!-- <i class="fa fa-fw fa-clock-o"></i><span v-html="showInitDate(item.createTime,'all')">{{showInitDate(item.createTime,'all')}}</span> • -->
